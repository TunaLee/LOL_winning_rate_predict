...
LOCAL_APPS = [
    ...
    "backend.apps.champs.apps.ChampsConfig",
    "backend.apps.matchgames.apps.MatchgamesConfig",
    "backend.apps.inputdata.apps.InputdataConfig",
...
ADMINS = [("""Daniel Lee""", "dongwon1103@naver.com")]
